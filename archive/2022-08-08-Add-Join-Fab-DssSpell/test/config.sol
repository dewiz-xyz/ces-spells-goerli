...
contract Config {
    ...
    function setValues(address chief) public {
        ...
        afterSpell = SystemValues({
            ...
            ilk_count:             8               // Num expected in system
        });
        ...
        afterSpell.collaterals["RWA008AT4-A"] = CollateralValues({
            aL_enabled:   false,         // DssAutoLine is enabled?
            aL_line:      0,             // In whole Dai units
            aL_gap:       0,             // In whole Dai units
            aL_ttl:       1 hours,       // In seconds
        ...
        afterSpell.collaterals["RWA008AT5-A"] = CollateralValues({
            aL_enabled:   false,         // DssAutoLine is enabled?
            aL_line:      0,             // In whole Dai units
            aL_gap:       0,             // In whole Dai units
            aL_ttl:       1 hours,       // In seconds
        ...
        afterSpell.collaterals["RWA009AT3-A"] = CollateralValues({
            aL_enabled:   false,         // DssAutoLine is enabled?
            aL_line:      0,             // In whole Dai units
            aL_gap:       0,             // In whole Dai units
            aL_ttl:       1 hours,       // In seconds
        ...
        afterSpell.collaterals["RWA008AT6-A"] = CollateralValues({
            aL_enabled:   false,         // DssAutoLine is enabled?
            aL_line:      0,             // In whole Dai units
            aL_gap:       0,             // In whole Dai units
            aL_ttl:       1 hours,       // In seconds
