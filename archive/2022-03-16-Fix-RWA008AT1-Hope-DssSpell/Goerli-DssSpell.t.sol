...
contract DssSpellTest is GoerliDssSpellTestBase {
    ...
    function testNewChainlogValues() public { // make public to use
        ...
        assertEq(chainLog.version(), "0.2.2");
    }
    ...
    function testNewPermissions() public {
        ...
        assertEq(CanLike(RWA008AT1_A_RWA_URN).can(RWA008AT1_A_OPERATOR), 1);
        assertEq(CanLike(RWA008AT1_A_OUTPUT_CONDUIT).can(RWA008AT1_A_OPERATOR), 1);
    }
